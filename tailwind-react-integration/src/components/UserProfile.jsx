function UserProfile() {
  return (
    <div className="user-profile sm:p-4 md:p-8 max-w-xs md:max-w-sm mx-auto my-10 md:my-20 bg-gray-100 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <img
